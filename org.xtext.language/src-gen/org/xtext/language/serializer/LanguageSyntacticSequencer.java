...
public class LanguageSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_Var_VarKeyword_0_q;
	protected AbstractElementAlias match_Var___INTTerminalRuleCall_3_1_or_STRINGTerminalRuleCall_3_0__q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_Var_VarKeyword_0_q = new TokenAlias(false, true, grammarAccess.getVarAccess().getVarKeyword_0());
		match_Var___INTTerminalRuleCall_3_1_or_STRINGTerminalRuleCall_3_0__q = new AlternativeAlias(false, true, new TokenAlias(false, false, grammarAccess.getVarAccess().getINTTerminalRuleCall_3_1()), new TokenAlias(false, false, grammarAccess.getVarAccess().getSTRINGTerminalRuleCall_3_0()));
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if(match_Var_VarKeyword_0_q.equals(syntax))
				emit_Var_VarKeyword_0_q(semanticObject, getLastNavigableState(), syntaxNodes);
			else if(match_Var___INTTerminalRuleCall_3_1_or_STRINGTerminalRuleCall_3_0__q.equals(syntax))
				emit_Var___INTTerminalRuleCall_3_1_or_STRINGTerminalRuleCall_3_0__q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 */
	protected void emit_Var_VarKeyword_0_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
	 ...
	 */
	protected void emit_Var___INTTerminalRuleCall_3_1_or_STRINGTerminalRuleCall_3_0__q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
